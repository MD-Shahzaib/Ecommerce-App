            ...
            <div className="max-w-3xl mx-auto p-6">
                ...
                <form onSubmit={handlePayment} className="bg-white p-6 shadow-md rounded-md">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            <label htmlFor="cardExpiry" className="block text-gray-700 font-medium mb-2">Expiry Date</label>
                            <input
                                type="text"
                                id="cardExpiry"
                                className="w-full px-3 py-2 border rounded-md"
                    ...
                    {/* Payment button */}
                    <button type="submit" className="bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600">Pay Now</button>
                </form>
            </div>
        </div>
    );
